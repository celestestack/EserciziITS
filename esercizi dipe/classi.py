...
class Quadrato:
    ...
    def __str__(self):
        return f"Quadrato lato: {self.lato}, area: {self.area()} perimetro: {self.perimetro()}"
...
class Rettangolo:
    ...
    def __str__(self):
        return f"Rettango base: {self.base} altezza: {self.altezza}, area: {self.area()} perimetro: {self.perimetro()}"
